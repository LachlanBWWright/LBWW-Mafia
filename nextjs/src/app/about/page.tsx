          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                LBWW Mafia is an online multiplayer implementation of the
                classic Mafia social deduction game. Built with modern web
                technologies, it allows players from around the world to connect
                and play together in real-time.
              </p>
              <p className="text-muted-foreground">
                The game features multiple roles with unique abilities,
                day/night cycles, and strategic gameplay that tests your
                deduction skills and ability to read others.
              </p>
            </CardContent>
          </Card>
