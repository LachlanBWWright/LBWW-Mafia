    ...
    <Card style={{ margin: "2vh", flex: 1, overflow: "auto" }}>
      <Card.Body>
        ...
        <Card.Text>
          ...
          rutrum dapibus. Nunc faucibus nisl ut aliquam facilisis. Orci varius
          natoque penatibus et magnis dis parturient montes, nascetur ridiculus
          mus. Nunc dapibus lorem vel dui rutrum tristique quis eget nisi. Donec
          cursus sem faucibus ex rhoncus, vitae tempus massa aliquet. Lorem
          ipsum dolor sit amet, consectetur adipiscing elit. Nunc accumsan risus
          felis, et aliquam diam rhoncus eu. Nullam erat orci, porta tincidunt
